if vim.g.neovide then
    ...
    local g = vim.g
    local fonts = { "JetBrainsMono_Nerd_Font_Mono:h10", "AnonymicePro_Nerd_Font_Mono:h10", "LiterationMono_Nerd_Font_Mono:h10", "Monaspace_Argon_NF:h10" }
    opt.linespace                               = -6
    ...
    g.neovide_progress_bar_height               = 0.0
    g.neovide_progress_bar_animation_speed      = 0.0
